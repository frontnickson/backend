module.exports = { graphicDesignerTasks: [
  {
    ...
    "materials": [
      {
        "name": "Логотип Самокат",
        "type": "image",
        "isRequired": true
      },
      {
        "name": "Брендбук Самокат",
        "type": "reference",
        "isRequired": true
      },
      {
    ...
    "deliverables": [
      {
        "name": "4 креатива Instagram Stories",
  ...
  },
  {
    ...
    "materials": [
      {
        "name": "Иконки программирования",
        "type": "image",
        "isRequired": true
      },
      {
        "name": "Шрифты для кода",
        "type": "font",
        "isRequired": true
      }
    ],
  ...
  },
  {
    ...
    "materials": [
      ...
      {
        "name": "Анимационные элементы",
        "type": "template",
        "isRequired": true
      },
      {
        "name": "Трендовые шрифты",
        "type": "font",
        "isRequired": true
      }
    ],
    "deliverables": [
      {
        "name": "3 сторис TikTok",
        "format": "PNG 1080x1920",
        "isRequired": true
      },
      {
        "name": "Анимированная версия",
        "format": "MP4",
        "isRequired": false
      }
    ],
  ...
  },
  {
    ...
    "deliverables": [
      {
        "name": "5 слайдов карусели",
        "format": "PNG 1200x1200",
        "isRequired": true
      },
      {
        "name": "PDF версия",
  ...
  },
  {
    ...
    "materials": [
      ...
      {
        "name": "Шрифты для архитектуры",
        "type": "font",
        "isRequired": true
      },
      {
        "name": "Векторные элементы",
        "type": "template",
        "isRequired": true
      }
    ],
  ...
  },
  {
    ...
    "materials": [
      {
        "name": "Логотип CodeMaster",
        "type": "image",
        "isRequired": true
      },
      {
        "name": "Фото преподавателей",
        "type": "image",
        "isRequired": true
      },
      {
        "name": "Иконки технологий",
        "type": "image",
        "isRequired": true
      }
    ],
    "deliverables": [
      {
        "name": "Макет для десктопа",
        "format": "PNG",
        "isRequired": true
      },
      {
        "name": "Макет для мобильных",
        "format": "PNG",
        "isRequired": true
      },
      {
  ...
  },
  {
    ...
    "materials": [
      {
        "name": "Референсы кофейных логотипов",
        "type": "reference",
        "isRequired": true
      },
      {
        "name": "Шрифты для кафе",
        "type": "font",
        "isRequired": true
      },
      {
    ...
    "deliverables": [
      ...
      {
        "name": "Горизонтальный вариант",
        "format": "SVG",
        "isRequired": true
      },
      {
        "name": "Вертикальный вариант",
        "format": "SVG",
        "isRequired": true
      }
    ],
  ...
  },
  {
    ...
    "materials": [
      ...
      {
        "name": "Референсы детских иллюстраций",
        "type": "reference",
        "isRequired": true
      },
      {
        "name": "Кисти для иллюстрации",
        "type": "template",
        "isRequired": true
      }
    ],
    ...
    "client": {
      "name": "Детское издательство",
      "industry": "Издательство"
    },
    "tags": [
      "иллюстрация",
      "дети",
